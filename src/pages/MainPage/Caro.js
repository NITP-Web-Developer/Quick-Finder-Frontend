...
class Caro extends React.Component{
  ...
  <div class="container-fluid" style={{padding:'0px',width:'100%',height:'50%', maxHeight:'470px',boxShadow:'0 5px 10px rgb(0,0,0,0.16)',backgroundColor:'white'}}>
<Carousel>
<Carousel.Item>
    <img
      ...
      style={{width:'100%',objectFit:'cover',height:'100%',maxHeight:'470px', objectPosition: "25% 10%"}}
      alt="Third slide"
    />
